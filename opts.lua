...
function M.parse(arg)
   ...
   ---------- Model options ----------------------------------
   cmd:option('-netType',      'resnet', 'Options: resnet | preresnet | resnet-pre-act | densenet')
   ...
   ---------- DenseNet options ----------------------------------
   cmd:option('-growthRate',        12,    'Growth rate (k)')
   cmd:option('-dropRate',          0,     'Dropout rate')
   cmd:option('-bottleneck',      'true',  'Bottleneck and compression (BC)')
